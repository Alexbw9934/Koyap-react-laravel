...
import simg_flights from '../../images/jet.svg';
...
function Flights() {
    ...
    const SBanner = () => {
        if(flights.length >= 1) {
            return (
                <div className="items-center relative min-h-[300px]" style={{marginTop: '27px', marginBottom: '-50px'}}>
                    <img
                    ...
                    <div className="absolute top-0 left-0 items-center p-20 2xl:px-48 h-full">
                        <h1 className="font-bold text-3xl tracking-tight text-center sm:text-4xl lg:text-5xl text-indigo-500">
                            Call us on xxx-xxx-xxx to book your flight.
                        </h1>
                    </div>
                </div>
            )
